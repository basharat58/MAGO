...
{
    public class PropStrategy : BaseStrategy, IPlaneTypeStrategy
	{
		private readonly IOptions<PlaneConfig> _planeConfig;
		public PropStrategy(IOptions<PlaneConfig> planeConfig)
		{
			_planeConfig = planeConfig;
		}

		public int MinimumSlots { get => _planeConfig.Value.PropMinimumSlot; }
		public int MaximumSlots { get => _planeConfig.Value.PropMaximumSlot; }
		public int TotalSlots { get => _planeConfig.Value.TotalSlots; }
		public bool CanHandle(PlaneType planeType) => planeType == PlaneType.Prop;
